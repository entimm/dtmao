...
class Page{
    ...
    public function show() {
        ...
        $up_page = '';
        if($up_row > 0) {
            $up_page = '<li><a href="' . $this->url($up_row) . '" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>';
        } else {
            $up_page = '<li class="disabled"><span><span aria-hidden="true">&laquo;</span></span></a></li>';
        }
        ...
        if($down_row <= $this->totalPages) {
            $down_page = '<li><a href="' . $this->url($down_row) . '" aria-label="Next"><span aria-hidden="true">&raquo;</span></a></li>';
        } else {
            $down_page = '<li class="disabled"><span><span aria-hidden="true">&raquo;</span></span></a></li>';
        }
